...

        {
            ...
            var products = new List<Products>
            {
                new Products {name = "test product 1", price = 2.50, description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
                    longDescription = "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium", date = new DateTime(2017, 10, 10), CategoriesID = 1 },
                new Products { name = "test product 2", price = 4.20, description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
                    longDescription = "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium",  date = new DateTime(2017, 9, 9), CategoriesID = 2 },
                new Products { name = "test product 3", price = 2.50, description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
                    longDescription = "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium",  date = new DateTime(2017, 10, 10),CategoriesID = 4  },
                new Products {  name = "test product 4", price = 4.20, description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
                    longDescription = "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium",  date = new DateTime(2017, 9, 9),CategoriesID = 5  },
                new Products { name = "test product 5", price = 2.50, description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
                    longDescription = "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium",  date = new DateTime(2017, 10, 10),CategoriesID = 2  },
                new Products { name = "test product 6", price = 4.20, description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
                    longDescription = "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium",  date = new DateTime(2017, 9, 9),CategoriesID = 3  },
                ...
                new Products { name = "test product 9", price = 4.20, description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
                    longDescription = "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium",  date = new DateTime(2017, 9, 9),CategoriesID = 1  }
            };
